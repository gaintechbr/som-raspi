...
filename_in = "/media/pi/Leonardo/Projeto_Vale/Dados/SOM/20210122-143412/20210122-143412[Final].npz" #input("Informe o nome do arquivo de origem .npz: (com extensão)")
